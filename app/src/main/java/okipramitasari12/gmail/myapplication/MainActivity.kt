...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.setTitle("Badoy Shop")
        ...
        btnproses!!.setOnClickListener {
            val namapelanggan = edtnamapel!!.text.toString()
            val namabarang = edtnamabar!!.text.toString()
            val jumlahbeli = edtjumlahbel!!.text.toString()
            val harga = edtharga!!.text.toString()
            val uangbayar = edtuangbay!!.text.toString()
            val jb = java.lang.Double.parseDouble(jumlahbeli)
            val h = java.lang.Double.parseDouble(harga)
            val ub = java.lang.Double.parseDouble(uangbayar)
            val total = jb * h
